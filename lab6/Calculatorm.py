...
class Calculator(QWidget):
    def __init__(self):
        ...
        self.b_d = QPushButton("/", self)
        self.hbox_first.addWidget(self.b_d)
        ...
        self.hbox_result.addWidget(self.b_result)
        self.b_d.clicked.connect(lambda: self._operation("/"))
        self.hbox_result.addWidget(self.b_result)
    ...
    def _result(self):
        try:
            ...
            print(self.num_1,self.num_2,self.op)
            if self.op == "+":
            ...
            if self.op == "-":
                ...
                if self.num_2 != 0:
                    ...
                    self.input.setText('На ноль делить нелбзя')
        except:
            pass
